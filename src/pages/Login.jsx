...
import Footer from '../components/Page/Footer';  // Import Footer component
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage('🎉 Login successful! Redirecting you shortly...');  // Set success message
      setError('');  // Clear any existing errors

      // Wait 3 seconds, then navigate to the home page
      setTimeout(() => {
