            ...
            <div className={`${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'} min-h-screen flex flex-col`}>
                ...
                <div className="container mx-auto p-6 flex-grow">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <button className="p-4 rounded-lg shadow-lg bg-purple-600 text-white hover:bg-purple-700 transition-all" onClick={() => navigate("/reservations")}>
                            Reservations
                        </button>

                        {/* Housekeeping page redirect */}
                        <button className="p-4 rounded-lg shadow-lg bg-teal-600 text-white hover:bg-teal-700 transition-all" onClick={() => navigate("/housekeeping")}>
                            House Keeping
                        </button>
                    </div>
                </div>
